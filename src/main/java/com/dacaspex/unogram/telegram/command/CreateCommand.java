...
public class CreateCommand {
    ...
    public void execute(Update update) {
        ...
        String gameId = "1234"; // TODO: Generate
        CompoundAnnouncer announcer = new CompoundAnnouncer(
                new ConsoleAnnouncer(gameId),
                new TelegramAnnouncer(sender, gameId, botUsername)
        );
        GameController controller = new GameController(gameId, announcer);
